...
export function playClick() {
  ...
  g.gain.setValueAtTime(6.40, now)
...
export function playTick() {
  ...
  const g = c.createGain()
  g.gain.setValueAtTime(9.60, now)
...
export function playGoal() {
  ...
  cheerG.gain.linearRampToValueAtTime(3.20, now + 0.22)
  cheerG.gain.setValueAtTime(3.20, now + 0.48)
...
export function playSuccess() {
  ...
  ;[523.25, 659.25, 783.99, 1046.50].forEach((freq, i) => {
    ...
    g.gain.linearRampToValueAtTime(4.80, t + 0.015)
    g.gain.setValueAtTime(9.60, t + 0.07)
