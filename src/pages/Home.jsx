                      ...
                      <div key={p.id}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2 flex-1 min-w-0">
                            <FlagEmoji emoji={p.flag_local} size="md" team={p.equipo_local} className="flex-shrink-0" />
                          ...
                          <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
                            ...
                            <FlagEmoji emoji={p.flag_visitante} size="md" team={p.equipo_visitante} className="flex-shrink-0" />
                          </div>
                        </div>
